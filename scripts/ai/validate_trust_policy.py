#!/usr/bin/env python3
"""Validate the candidate UEOT trust policy structure using Python stdlib only.

Security note: this validates syntax/shape only. Authorization always resolves the policy
from the PR base SHA / integrated main, never from the candidate head.
"""
